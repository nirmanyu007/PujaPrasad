...
const ArtiDetail: React.FC = () => {
  const route = useRoute<RouteProp<StackParamList, 'ArtiDetail'>>();
  ...
  // Choose description based on language and strip HTML tags
