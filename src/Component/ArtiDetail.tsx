...
const ArtiDetail = () => {
  ...
  const handleLanguageToggle = () => {
    setIsHindi(!isHindi);
    console.log('Language toggled:', isHindi ? 'English' : 'Hindi');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={{
          uri: 'https://vedic-vaibhav.blr1.cdn.digitaloceanspaces.com/vedic-vaibhav/Puja-Prasad-App/Puja/krishna.png',
        }}
        style={styles.image}
      />
...
const styles = StyleSheet.create({
  ...
  icon: {
    marginRight: 5, // Add spacing between the icon and the image
  },
  languageImage: {
    width: 35,
    height: 20,
